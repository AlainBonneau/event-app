    ...
    <div className="pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          />
          <ServiceCard
            title="Créer ou rejoignez des événements"
            details="Créez des événements et partagez-les avec d'autres personnes ou rejoignez des événements organisés par d'autres personnes."
            icon={
              <svg
                width="36"
                height="36"
