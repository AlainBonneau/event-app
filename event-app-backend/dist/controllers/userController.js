...
exports.updateUser = exports.deleteUser = exports.getAllUsers = exports.deleteAccount = exports.updateProfile = exports.getCurrentUser = exports.getUserProfile = exports.loginUser = exports.registerUser = void 0;
...
const registerUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: newUser.id, email }, process.env.JWT_SECRET, { expiresIn: "2h" });
        res
            .status(201)
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: user.id, email: user.email, role: user.role }, process.env.JWT_SECRET, { expiresIn: "2h" });
        res.status(200).json({
...
const updateProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (password) {
            const saltRounds = 10;
            updatedData.password = yield bcryptjs_1.default.hash(password, saltRounds);
        }
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const deletedUser = yield User_1.default.destroy({ where: { id } });
        if (deletedUser === 0) {
            res.status(404).json({ message: "Utilisateur introuvable" });
            return;
        }
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield User_1.default.update({ email, lastname, firstname, role }, { where: { id } });
